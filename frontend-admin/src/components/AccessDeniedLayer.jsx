    ...
    <div className='custom-bg'>
      <div className='container container--xl'>
        <div className='d-flex align-items-center justify-content-between py-24'>
          ...
          <Link href='/sign-in' className='btn btn-outline-primary-600 text-sm'>
            {" "}
            Kthehu tek Login{" "}
          </Link>
        </div>
        ...
        <div className='pt-48 pb-40 text-center'>
          <div className='max-w-700-px mx-auto mt-40'>
            <h3 className='mb-24 max-w-1000-px' style={{color: "#c72b04"}}>Akses i ndaluar</h3>
            <p className='text-neutral-500 max-w-700-px text-lg'>
              Ju nuk keni autorizim të futeni dhe të kryeni veprime në këtë faqe. Ju lutemi kthehuni në faqen e Login dhe përdorni një llogari tjetër nëse keni.
            </p>
            <Link
              href='/sign-in'
            ...
            >
              <i className='ri-home-4-line' /> Kthehu tek Login
            </Link>
          </div>
        </div>
      </div>
