...
const RequestListLayer = () => {
    ...
    const createRowHtml = (req) => {
        ...
        ${truncateText(req.description, 50)}
            ...
            `<div class="d-flex">
  <!-- Syri blu -->
  <a href="/request-view/${req.id}" 
     class="w-32-px h-32-px me-8 bg-primary-light text-primary rounded-circle d-inline-flex align-items-center justify-content-center view-btn" 
  ...
  <!-- Lapsi jeshil -->
  <button 
    class="change-status-btn w-32-px h-32-px me-8 bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center border-0" 
    data-id="${req.id}" 
    title="Ndrysho Status">
    <svg width="16" height="16" viewBox="0 0 24 24">
