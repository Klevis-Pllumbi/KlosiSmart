    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li className='sidebar-menu-group-title'>Aplikacioni</li>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                      href='/survey-list'
                      className={
                        pathname === "/survey-list" ? "active-page" : ""
                      }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/>{" "}
                    Lista
                ...
                <li>
                  <Link
                      href='/survey-add'
                      className={
                        pathname === "/survey-add" ? "active-page" : ""
                      }
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto'/>
                    Shto Pyetësor
            ...
            <li className='dropdown'>
              <Link href='#'>
                <Icon icon='eva:clipboard-outline' className='menu-icon'/>
                <span>Raportime/Kërkesa</span>
              </Link>
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                      href='/request-map'
                      className={
                        pathname === "/request-map" ? "active-page" : ""
                      }
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto'/>
                    Harta
                ...
                <li>
                  <Link
                      href='/request-list'
                      className={
                        pathname === "/request-list" ? "active-page" : ""
                      }
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/>{" "}
                    Lista
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                      href='/news'
                      className={pathname === "/news" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/>{" "}
                    Lajme
                  </Link>
                ...
                <li>
                  <Link
                      href='/add-news'
                      className={pathname === "/add-news" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto'/>{" "}
                    Shto Lajm
                  </Link>
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                      href='/events'
                      className={pathname === "/events" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto'/>{" "}
                    Evente
                  </Link>
                ...
                <li>
                  <Link
                      href='/add-event'
                      className={pathname === "/add-event" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto'/>{" "}
                    Shto Event
                  </Link>
      ...
      >
            ...
            <div className='col-auto'>
              <div className='d-flex flex-wrap align-items-center gap-3'>
                ...
                <div className='dropdown'>
                  ...
                  {/*/>*/}
                    <Icon icon='lucide:user' className='icon text-xl'></Icon>
                  </button>
                <div className='dropdown-menu to-top dropdown-menu-sm'>
                  <div
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© 2025 KlosiSmart - Të gjitha të drejtat e rezervuara.</p>
            </div>
            {/*<div className='col-auto'>*/}
            {/*  <p className='mb-0'>*/}
